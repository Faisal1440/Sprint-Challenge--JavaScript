...
zooAnimals.map(elements => {
  lowCaseAnimalNames.push(elements.animal_name.toLowerCase())
})
...
*/
const lowPopulationAnimals = zooAnimals.filter(elements => elements.population < 5);
